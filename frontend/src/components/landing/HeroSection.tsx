      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20">
        ...
        <div className="mb-8 flex justify-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-border bg-secondary/50 px-4 py-1.5 text-sm">
            ...
            <span className="text-muted-foreground">
              Learn to code with short, focused videos
            </span>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-3xl text-center">
          <h1 className="font-heading text-4xl font-bold leading-tight tracking-tight sm:text-5xl lg:text-6xl">
            Watch. Code. <span className="text-gradient-ember">Master.</span>
          </h1>

          <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
            Short video tutorials paired with a live IDE — learn by watching
            and coding side by side. No context switching, no friction.
          </p>
